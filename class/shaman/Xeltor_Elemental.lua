...
AddFunction ElementalSingleAscMainActions
{
 ...
 if BuffPresent(echoes_of_the_great_sundering_buff) and { Maelstrom() >= 111 or not HasArtifactTrait(swelling_maelstrom) and Maelstrom() >= 86 or HasEquippedItem(the_deceivers_blood_pact) and Maelstrom() > 85 and Talent(aftershock_talent) } Spell(earthquake)
