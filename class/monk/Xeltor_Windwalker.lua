...
AddFunction WindwalkerAoeMainActions
{
 ...
 unless WindwalkerCdMainPostConditions()
 {
  ...
  if { Enemies(tagged=1) >= 3 or BuffPresent(blackout_kick_buff) and MaxChi() - Chi() >= 0 } and not PreviousGCDSpell(spinning_crane_kick) and ArmorSetBonus(T21 4) Spell(spinning_crane_kick)
