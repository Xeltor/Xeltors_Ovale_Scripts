...
AddFunction AfflictionDefaultMainActions
{
	...
	if target.DebuffRemaining(corruption_debuff) <= target.TickTime(corruption_debuff) + GCD() and { Enemies(tagged=1) < 3 and Talent(sow_the_seeds_talent) or Enemies(tagged=1) < 4 } and { target.DebuffStacks(unstable_affliction_debuff) < 2 and SoulShards() == 0 or not Talent(malefic_grasp_talent) } Spell(corruption)
	...
	if { Talent(absolute_corruption_talent) or not Talent(malefic_grasp_talent) or not Talent(soul_effigy_talent) } and Enemies(tagged=1) > 1 and target.DebuffRemaining(corruption_debuff) <= target.TickTime(corruption_debuff) + GCD() and { Enemies(tagged=1) < 3 and Talent(sow_the_seeds_talent) or Enemies(tagged=1) < 4 } Spell(corruption)
	...
	if { not Talent(malefic_grasp_talent) or not Talent(soul_effigy_talent) } and Enemies(tagged=1) > 1 and target.DebuffRemaining(siphon_life_debuff) <= target.TickTime(siphon_life_debuff) + GCD() Spell(siphon_life)
	...
	if Talent(sow_the_seeds_talent) and Enemies(tagged=1) >= 3 or Enemies(tagged=1) >= 4 or Enemies(tagged=1) == 3 and target.DebuffRemaining(corruption_debuff) <= CastTime(seed_of_corruption) + TravelTime(seed_of_corruption) Spell(seed_of_corruption)
	...
	if { not Talent(sow_the_seeds_talent) or Enemies(tagged=1) < 3 } and Talent(haunt_talent) and { SoulShards() >= 4 or target.DebuffRemaining(haunt_debuff) > 6.5 or target.TimeToDie() < 30 } Spell(unstable_affliction)
	...
	if { not Talent(sow_the_seeds_talent) or Enemies(tagged=1) < 3 } and Enemies(tagged=1) < 4 and Talent(writhe_in_agony_talent) and Talent(contagion_talent) and target.DebuffStacks(unstable_affliction_debuff) >= 1 < CastTime(unstable_affliction) and target.DebuffStacks(unstable_affliction_debuff) >= 2 < CastTime(unstable_affliction) and target.DebuffStacks(unstable_affliction_debuff) >= 3 < CastTime(unstable_affliction) and target.DebuffStacks(unstable_affliction_debuff) >= 4 < CastTime(unstable_affliction) and target.DebuffStacks(unstable_affliction_debuff) >= 5 < CastTime(unstable_affliction) Spell(unstable_affliction)
	...
	if { not Talent(sow_the_seeds_talent) or Enemies(tagged=1) < 3 } and Enemies(tagged=1) < 4 and Talent(malefic_grasp_talent) and { target.TimeToDie() < 30 or PreviousGCDSpell(unstable_affliction) and SoulShards() >= 4 } Spell(unstable_affliction)
	...
	if { not Talent(sow_the_seeds_talent) or Enemies(tagged=1) < 3 } and Enemies(tagged=1) < 4 and Talent(malefic_grasp_talent) and { SoulShards() == 5 or Talent(contagion_talent) and SoulShards() >= 4 } Spell(unstable_affliction)
	...
	if { not Talent(sow_the_seeds_talent) or Enemies(tagged=1) < 3 } and Enemies(tagged=1) < 4 and Talent(malefic_grasp_talent) and { Talent(soul_effigy_talent) or HasEquippedItem(132457) } and not PreviousGCDSpell(unstable_affliction count=3) and PreviousGCDSpell(unstable_affliction) Spell(unstable_affliction)
	...
	if { not Talent(sow_the_seeds_talent) or Enemies(tagged=1) < 3 } and Enemies(tagged=1) < 4 and Talent(malefic_grasp_talent) and HasEquippedItem(132457) and target.DebuffStacks(unstable_affliction_debuff) == 0 Spell(unstable_affliction)
...
AddFunction AfflictionDefaultShortCdActions
{
	unless not BuffPresent(deadwind_harvester_buff) and { BuffRemaining(soul_harvest_buff) > 5 + HasEquippedItem(144364) * 1.5 and not Talent(malefic_grasp_talent) and target.DebuffStacks(unstable_affliction_debuff) > 1 or BuffStacks(tormented_souls_buff) >= 8 or target.TimeToDie() <= BuffStacks(tormented_souls_buff) * 5 + HasEquippedItem(144364) * 1.5 or not Talent(malefic_grasp_talent) and { BuffPresent(trinket_proc_any_buff) or BuffPresent(trinket_stacking_proc_any_buff) } } and Spell(reap_souls) or not pet.Present() and Spell(soul_effigy) or target.DebuffRemaining(agony_debuff) <= target.TickTime(agony_debuff) + GCD() and Spell(agony)
	{
		...
		unless target.DebuffRemaining(corruption_debuff) <= target.TickTime(corruption_debuff) + GCD() and { Enemies(tagged=1) < 3 and Talent(sow_the_seeds_talent) or Enemies(tagged=1) < 4 } and { target.DebuffStacks(unstable_affliction_debuff) < 2 and SoulShards() == 0 or not Talent(malefic_grasp_talent) } and Spell(corruption) or { Talent(absolute_corruption_talent) or not Talent(malefic_grasp_talent) or not Talent(soul_effigy_talent) } and Enemies(tagged=1) > 1 and target.DebuffRemaining(corruption_debuff) <= target.TickTime(corruption_debuff) + GCD() and { Enemies(tagged=1) < 3 and Talent(sow_the_seeds_talent) or Enemies(tagged=1) < 4 } and Spell(corruption) or target.DebuffRemaining(siphon_life_debuff) <= target.TickTime(siphon_life_debuff) + GCD() and { target.DebuffStacks(unstable_affliction_debuff) < 2 and SoulShards() == 0 or not Talent(malefic_grasp_talent) } and Spell(siphon_life) or { not Talent(malefic_grasp_talent) or not Talent(soul_effigy_talent) } and Enemies(tagged=1) > 1 and target.DebuffRemaining(siphon_life_debuff) <= target.TickTime(siphon_life_debuff) + GCD() and Spell(siphon_life) or Talent(empowered_life_tap_talent) and BuffRemaining(empowered_life_tap_buff) <= GCD() and Spell(life_tap)
		{
			#phantom_singularity
...
{
	not BuffPresent(deadwind_harvester_buff) and { BuffRemaining(soul_harvest_buff) > 5 + HasEquippedItem(144364) * 1.5 and not Talent(malefic_grasp_talent) and target.DebuffStacks(unstable_affliction_debuff) > 1 or BuffStacks(tormented_souls_buff) >= 8 or target.TimeToDie() <= BuffStacks(tormented_souls_buff) * 5 + HasEquippedItem(144364) * 1.5 or not Talent(malefic_grasp_talent) and { BuffPresent(trinket_proc_any_buff) or BuffPresent(trinket_stacking_proc_any_buff) } } and Spell(reap_souls) or not pet.Present() and Spell(soul_effigy) or target.DebuffRemaining(agony_debuff) <= target.TickTime(agony_debuff) + GCD() and Spell(agony) or target.DebuffRemaining(corruption_debuff) <= target.TickTime(corruption_debuff) + GCD() and { Enemies(tagged=1) < 3 and Talent(sow_the_seeds_talent) or Enemies(tagged=1) < 4 } and { target.DebuffStacks(unstable_affliction_debuff) < 2 and SoulShards() == 0 or not Talent(malefic_grasp_talent) } and Spell(corruption) or { Talent(absolute_corruption_talent) or not Talent(malefic_grasp_talent) or not Talent(soul_effigy_talent) } and Enemies(tagged=1) > 1 and target.DebuffRemaining(corruption_debuff) <= target.TickTime(corruption_debuff) + GCD() and { Enemies(tagged=1) < 3 and Talent(sow_the_seeds_talent) or Enemies(tagged=1) < 4 } and Spell(corruption) or target.DebuffRemaining(siphon_life_debuff) <= target.TickTime(siphon_life_debuff) + GCD() and { target.DebuffStacks(unstable_affliction_debuff) < 2 and SoulShards() == 0 or not Talent(malefic_grasp_talent) } and Spell(siphon_life) or { not Talent(malefic_grasp_talent) or not Talent(soul_effigy_talent) } and Enemies(tagged=1) > 1 and target.DebuffRemaining(siphon_life_debuff) <= target.TickTime(siphon_life_debuff) + GCD() and Spell(siphon_life) or Talent(empowered_life_tap_talent) and BuffRemaining(empowered_life_tap_buff) <= GCD() and Spell(life_tap) or Spell(haunt) or not Talent(malefic_grasp_talent) and target.DebuffRemaining(agony_debuff) <= BaseDuration(agony_debuff) * 0.3 and target.TimeToDie() >= target.DebuffRemaining(agony_debuff) and Spell(agony) or target.DebuffRemaining(agony_debuff) <= BaseDuration(agony_debuff) * 0.3 and target.TimeToDie() >= target.DebuffRemaining(agony_debuff) and target.DebuffStacks(unstable_affliction_debuff) == 0 and Spell(agony) or { Talent(empowered_life_tap_talent) and BuffRemaining(empowered_life_tap_buff) < BaseDuration(empowered_life_tap_buff) * 0.3 or Talent(malefic_grasp_talent) and target.TimeToDie() > 15 and ManaPercent() < 10 } and Spell(life_tap) or { Talent(sow_the_seeds_talent) and Enemies(tagged=1) >= 3 or Enemies(tagged=1) >= 4 or Enemies(tagged=1) == 3 and target.DebuffRemaining(corruption_debuff) <= CastTime(seed_of_corruption) + TravelTime(seed_of_corruption) } and Spell(seed_of_corruption) or not Talent(malefic_grasp_talent) and target.DebuffRemaining(corruption_debuff) <= BaseDuration(corruption_debuff) * 0.3 and target.TimeToDie() >= target.DebuffRemaining(corruption_debuff) and Spell(corruption) or target.DebuffRemaining(corruption_debuff) <= BaseDuration(corruption_debuff) * 0.3 and target.TimeToDie() >= target.DebuffRemaining(corruption_debuff) and target.DebuffStacks(unstable_affliction_debuff) == 0 and Spell(corruption) or { Talent(absolute_corruption_talent) or not Talent(malefic_grasp_talent) or not Talent(soul_effigy_talent) } and target.DebuffRemaining(corruption_debuff) <= BaseDuration(corruption_debuff) * 0.3 and target.TimeToDie() >= target.DebuffRemaining(corruption_debuff) and Spell(corruption) or not Talent(malefic_grasp_talent) and target.DebuffRemaining(siphon_life_debuff) <= BaseDuration(siphon_life_debuff) * 0.3 and target.TimeToDie() >= target.DebuffRemaining(siphon_life_debuff) and Spell(siphon_life) or target.DebuffRemaining(siphon_life_debuff) <= BaseDuration(siphon_life_debuff) * 0.3 and target.TimeToDie() >= target.DebuffRemaining(siphon_life_debuff) and target.DebuffStacks(unstable_affliction_debuff) == 0 and Spell(siphon_life) or { not Talent(malefic_grasp_talent) or not Talent(soul_effigy_talent) } and target.DebuffRemaining(siphon_life_debuff) <= BaseDuration(siphon_life_debuff) * 0.3 and target.TimeToDie() >= target.DebuffRemaining(siphon_life_debuff) and Spell(siphon_life) or { not Talent(sow_the_seeds_talent) or Enemies(tagged=1) < 3 } and Talent(haunt_talent) and { SoulShards() >= 4 or target.DebuffRemaining(haunt_debuff) > 6.5 or target.TimeToDie() < 30 } and Spell(unstable_affliction) or { not Talent(sow_the_seeds_talent) or Enemies(tagged=1) < 3 } and Enemies(tagged=1) < 4 and Talent(writhe_in_agony_talent) and Talent(contagion_talent) and target.DebuffStacks(unstable_affliction_debuff) >= 1 < CastTime(unstable_affliction) and target.DebuffStacks(unstable_affliction_debuff) >= 2 < CastTime(unstable_affliction) and target.DebuffStacks(unstable_affliction_debuff) >= 3 < CastTime(unstable_affliction) and target.DebuffStacks(unstable_affliction_debuff) >= 4 < CastTime(unstable_affliction) and target.DebuffStacks(unstable_affliction_debuff) >= 5 < CastTime(unstable_affliction) and Spell(unstable_affliction) or { not Talent(sow_the_seeds_talent) or Enemies(tagged=1) < 3 } and Enemies(tagged=1) < 4 and Talent(writhe_in_agony_talent) and { SoulShards() >= 4 or BuffPresent(trinket_proc_intellect_buff) or BuffPresent(trinket_stacking_proc_mastery_buff) or BuffPresent(trinket_proc_mastery_buff) or BuffPresent(trinket_proc_crit_buff) or BuffPresent(trinket_proc_versatility_buff) or BuffPresent(soul_harvest_buff) or BuffPresent(deadwind_harvester_buff) or BuffStacks(compounding_horror_buff) == 5 or target.TimeToDie() <= 20 } and Spell(unstable_affliction) or { not Talent(sow_the_seeds_talent) or Enemies(tagged=1) < 3 } and Enemies(tagged=1) < 4 and Talent(malefic_grasp_talent) and { target.TimeToDie() < 30 or PreviousGCDSpell(unstable_affliction) and SoulShards() >= 4 } and Spell(unstable_affliction) or { not Talent(sow_the_seeds_talent) or Enemies(tagged=1) < 3 } and Enemies(tagged=1) < 4 and Talent(malefic_grasp_talent) and { SoulShards() == 5 or Talent(contagion_talent) and SoulShards() >= 4 } and Spell(unstable_affliction) or { not Talent(sow_the_seeds_talent) or Enemies(tagged=1) < 3 } and Enemies(tagged=1) < 4 and Talent(malefic_grasp_talent) and { Talent(soul_effigy_talent) or HasEquippedItem(132457) } and not PreviousGCDSpell(unstable_affliction count=3) and PreviousGCDSpell(unstable_affliction) and Spell(unstable_affliction) or { not Talent(sow_the_seeds_talent) or Enemies(tagged=1) < 3 } and Enemies(tagged=1) < 4 and Talent(malefic_grasp_talent) and HasEquippedItem(132457) and target.DebuffStacks(unstable_affliction_debuff) == 0 and Spell(unstable_affliction) or { not Talent(sow_the_seeds_talent) or Enemies(tagged=1) < 3 } and Enemies(tagged=1) < 4 and Talent(malefic_grasp_talent) and Talent(soul_effigy_talent) and not HasEquippedItem(132457) and target.DebuffStacks(unstable_affliction_debuff) == 0 and target.DebuffRemaining(agony_debuff) > CastTime(unstable_affliction) * 3 + 6.5 and { not Talent(soul_effigy_talent) or pet.DebuffRemaining(agony_debuff) > CastTime(unstable_affliction) * 3 + 6.5 } and Spell(unstable_affliction) or { not Talent(sow_the_seeds_talent) or Enemies(tagged=1) < 3 } and Enemies(tagged=1) < 4 and Talent(malefic_grasp_talent) and not Talent(soul_effigy_talent) and not HasEquippedItem(132457) and not PreviousGCDSpell(unstable_affliction count=3) and target.DebuffRemaining(agony_debuff) > CastTime(unstable_affliction) * 3 + 6.5 and { target.DebuffRemaining(corruption_debuff) > CastTime(unstable_affliction) + 6.5 or Talent(absolute_corruption_talent) } and Spell(unstable_affliction) or not BuffPresent(deadwind_harvester_buff) and target.DebuffStacks(unstable_affliction_debuff) > 1 and { not True(trinket_has_stacking_stat_any) and not True(trinket_has_stat_any) or Talent(malefic_grasp_talent) } and Spell(reap_souls) or not BuffPresent(deadwind_harvester_buff) and PreviousGCDSpell(unstable_affliction) and { not True(trinket_has_stacking_stat_any) and not True(trinket_has_stat_any) or Talent(malefic_grasp_talent) } and BuffStacks(tormented_souls_buff) > 1 and Spell(reap_souls) or ManaPercent() <= 10 and Spell(life_tap) or Spell(drain_soul) or Spell(life_tap)
}
...
{
	not BuffPresent(deadwind_harvester_buff) and { BuffRemaining(soul_harvest_buff) > 5 + HasEquippedItem(144364) * 1.5 and not Talent(malefic_grasp_talent) and target.DebuffStacks(unstable_affliction_debuff) > 1 or BuffStacks(tormented_souls_buff) >= 8 or target.TimeToDie() <= BuffStacks(tormented_souls_buff) * 5 + HasEquippedItem(144364) * 1.5 or not Talent(malefic_grasp_talent) and { BuffPresent(trinket_proc_any_buff) or BuffPresent(trinket_stacking_proc_any_buff) } } and Spell(reap_souls) or not pet.Present() and Spell(soul_effigy) or target.DebuffRemaining(agony_debuff) <= target.TickTime(agony_debuff) + GCD() and Spell(agony) or target.DebuffRemaining(corruption_debuff) and target.DebuffRemaining(agony_debuff) and Spell(service_felhunter) or target.DebuffRemaining(corruption_debuff) <= target.TickTime(corruption_debuff) + GCD() and { Enemies(tagged=1) < 3 and Talent(sow_the_seeds_talent) or Enemies(tagged=1) < 4 } and { target.DebuffStacks(unstable_affliction_debuff) < 2 and SoulShards() == 0 or not Talent(malefic_grasp_talent) } and Spell(corruption) or { Talent(absolute_corruption_talent) or not Talent(malefic_grasp_talent) or not Talent(soul_effigy_talent) } and Enemies(tagged=1) > 1 and target.DebuffRemaining(corruption_debuff) <= target.TickTime(corruption_debuff) + GCD() and { Enemies(tagged=1) < 3 and Talent(sow_the_seeds_talent) or Enemies(tagged=1) < 4 } and Spell(corruption) or target.DebuffRemaining(siphon_life_debuff) <= target.TickTime(siphon_life_debuff) + GCD() and { target.DebuffStacks(unstable_affliction_debuff) < 2 and SoulShards() == 0 or not Talent(malefic_grasp_talent) } and Spell(siphon_life) or { not Talent(malefic_grasp_talent) or not Talent(soul_effigy_talent) } and Enemies(tagged=1) > 1 and target.DebuffRemaining(siphon_life_debuff) <= target.TickTime(siphon_life_debuff) + GCD() and Spell(siphon_life) or Talent(empowered_life_tap_talent) and BuffRemaining(empowered_life_tap_buff) <= GCD() and Spell(life_tap) or Spell(phantom_singularity) or Spell(haunt) or not Talent(malefic_grasp_talent) and target.DebuffRemaining(agony_debuff) <= BaseDuration(agony_debuff) * 0.3 and target.TimeToDie() >= target.DebuffRemaining(agony_debuff) and Spell(agony) or target.DebuffRemaining(agony_debuff) <= BaseDuration(agony_debuff) * 0.3 and target.TimeToDie() >= target.DebuffRemaining(agony_debuff) and target.DebuffStacks(unstable_affliction_debuff) == 0 and Spell(agony) or { Talent(empowered_life_tap_talent) and BuffRemaining(empowered_life_tap_buff) < BaseDuration(empowered_life_tap_buff) * 0.3 or Talent(malefic_grasp_talent) and target.TimeToDie() > 15 and ManaPercent() < 10 } and Spell(life_tap) or { Talent(sow_the_seeds_talent) and Enemies(tagged=1) >= 3 or Enemies(tagged=1) >= 4 or Enemies(tagged=1) == 3 and target.DebuffRemaining(corruption_debuff) <= CastTime(seed_of_corruption) + TravelTime(seed_of_corruption) } and Spell(seed_of_corruption) or not Talent(malefic_grasp_talent) and target.DebuffRemaining(corruption_debuff) <= BaseDuration(corruption_debuff) * 0.3 and target.TimeToDie() >= target.DebuffRemaining(corruption_debuff) and Spell(corruption) or target.DebuffRemaining(corruption_debuff) <= BaseDuration(corruption_debuff) * 0.3 and target.TimeToDie() >= target.DebuffRemaining(corruption_debuff) and target.DebuffStacks(unstable_affliction_debuff) == 0 and Spell(corruption) or { Talent(absolute_corruption_talent) or not Talent(malefic_grasp_talent) or not Talent(soul_effigy_talent) } and target.DebuffRemaining(corruption_debuff) <= BaseDuration(corruption_debuff) * 0.3 and target.TimeToDie() >= target.DebuffRemaining(corruption_debuff) and Spell(corruption) or not Talent(malefic_grasp_talent) and target.DebuffRemaining(siphon_life_debuff) <= BaseDuration(siphon_life_debuff) * 0.3 and target.TimeToDie() >= target.DebuffRemaining(siphon_life_debuff) and Spell(siphon_life) or target.DebuffRemaining(siphon_life_debuff) <= BaseDuration(siphon_life_debuff) * 0.3 and target.TimeToDie() >= target.DebuffRemaining(siphon_life_debuff) and target.DebuffStacks(unstable_affliction_debuff) == 0 and Spell(siphon_life) or { not Talent(malefic_grasp_talent) or not Talent(soul_effigy_talent) } and target.DebuffRemaining(siphon_life_debuff) <= BaseDuration(siphon_life_debuff) * 0.3 and target.TimeToDie() >= target.DebuffRemaining(siphon_life_debuff) and Spell(siphon_life) or { not Talent(sow_the_seeds_talent) or Enemies(tagged=1) < 3 } and Talent(haunt_talent) and { SoulShards() >= 4 or target.DebuffRemaining(haunt_debuff) > 6.5 or target.TimeToDie() < 30 } and Spell(unstable_affliction) or { not Talent(sow_the_seeds_talent) or Enemies(tagged=1) < 3 } and Enemies(tagged=1) < 4 and Talent(writhe_in_agony_talent) and Talent(contagion_talent) and target.DebuffStacks(unstable_affliction_debuff) >= 1 < CastTime(unstable_affliction) and target.DebuffStacks(unstable_affliction_debuff) >= 2 < CastTime(unstable_affliction) and target.DebuffStacks(unstable_affliction_debuff) >= 3 < CastTime(unstable_affliction) and target.DebuffStacks(unstable_affliction_debuff) >= 4 < CastTime(unstable_affliction) and target.DebuffStacks(unstable_affliction_debuff) >= 5 < CastTime(unstable_affliction) and Spell(unstable_affliction) or { not Talent(sow_the_seeds_talent) or Enemies(tagged=1) < 3 } and Enemies(tagged=1) < 4 and Talent(writhe_in_agony_talent) and { SoulShards() >= 4 or BuffPresent(trinket_proc_intellect_buff) or BuffPresent(trinket_stacking_proc_mastery_buff) or BuffPresent(trinket_proc_mastery_buff) or BuffPresent(trinket_proc_crit_buff) or BuffPresent(trinket_proc_versatility_buff) or BuffPresent(soul_harvest_buff) or BuffPresent(deadwind_harvester_buff) or BuffStacks(compounding_horror_buff) == 5 or target.TimeToDie() <= 20 } and Spell(unstable_affliction) or { not Talent(sow_the_seeds_talent) or Enemies(tagged=1) < 3 } and Enemies(tagged=1) < 4 and Talent(malefic_grasp_talent) and { target.TimeToDie() < 30 or PreviousGCDSpell(unstable_affliction) and SoulShards() >= 4 } and Spell(unstable_affliction) or { not Talent(sow_the_seeds_talent) or Enemies(tagged=1) < 3 } and Enemies(tagged=1) < 4 and Talent(malefic_grasp_talent) and { SoulShards() == 5 or Talent(contagion_talent) and SoulShards() >= 4 } and Spell(unstable_affliction) or { not Talent(sow_the_seeds_talent) or Enemies(tagged=1) < 3 } and Enemies(tagged=1) < 4 and Talent(malefic_grasp_talent) and { Talent(soul_effigy_talent) or HasEquippedItem(132457) } and not PreviousGCDSpell(unstable_affliction count=3) and PreviousGCDSpell(unstable_affliction) and Spell(unstable_affliction) or { not Talent(sow_the_seeds_talent) or Enemies(tagged=1) < 3 } and Enemies(tagged=1) < 4 and Talent(malefic_grasp_talent) and HasEquippedItem(132457) and target.DebuffStacks(unstable_affliction_debuff) == 0 and Spell(unstable_affliction) or { not Talent(sow_the_seeds_talent) or Enemies(tagged=1) < 3 } and Enemies(tagged=1) < 4 and Talent(malefic_grasp_talent) and Talent(soul_effigy_talent) and not HasEquippedItem(132457) and target.DebuffStacks(unstable_affliction_debuff) == 0 and target.DebuffRemaining(agony_debuff) > CastTime(unstable_affliction) * 3 + 6.5 and { not Talent(soul_effigy_talent) or pet.DebuffRemaining(agony_debuff) > CastTime(unstable_affliction) * 3 + 6.5 } and Spell(unstable_affliction) or { not Talent(sow_the_seeds_talent) or Enemies(tagged=1) < 3 } and Enemies(tagged=1) < 4 and Talent(malefic_grasp_talent) and not Talent(soul_effigy_talent) and not HasEquippedItem(132457) and not PreviousGCDSpell(unstable_affliction count=3) and target.DebuffRemaining(agony_debuff) > CastTime(unstable_affliction) * 3 + 6.5 and { target.DebuffRemaining(corruption_debuff) > CastTime(unstable_affliction) + 6.5 or Talent(absolute_corruption_talent) } and Spell(unstable_affliction) or not BuffPresent(deadwind_harvester_buff) and target.DebuffStacks(unstable_affliction_debuff) > 1 and { not True(trinket_has_stacking_stat_any) and not True(trinket_has_stat_any) or Talent(malefic_grasp_talent) } and Spell(reap_souls) or not BuffPresent(deadwind_harvester_buff) and PreviousGCDSpell(unstable_affliction) and { not True(trinket_has_stacking_stat_any) and not True(trinket_has_stat_any) or Talent(malefic_grasp_talent) } and BuffStacks(tormented_souls_buff) > 1 and Spell(reap_souls) or ManaPercent() <= 10 and Spell(life_tap) or Spell(drain_soul) or Spell(life_tap)
}
