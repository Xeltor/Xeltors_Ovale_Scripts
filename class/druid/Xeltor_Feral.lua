...
do
	...
	local desc = "[Xel][8.1.5] Druid: Feral"
	local code = [[
...
{
 ComboPoints() == 0 and Spell(feral_frenzy)
}
...
AddFunction FeralGeneratorsMainActions
{
 ...
 if Enemies(tagged=1) > 4 Spell(brutal_slash)
 #pool_resource,for_next=1
